...
class WorkshopNotes extends CRMEntity {
	var $db, $log; // Used in class functions of CRMEntity

	var $table_name = 'vtiger_workshopnotes';
	var $table_index= 'workshopnotesid';
	 ...
	 */
	var $customFieldTable = Array('vtiger_workshopnotescf', 'workshopnotesid');
	 ...
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_workshopnotes', 'vtiger_workshopnotescf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_workshopnotes'   => 'workshopnotesid',
		'vtiger_workshopnotescf' => 'workshopnotesid');
	...
	var $list_fields = Array (
		...
		'workshopnotes_no'=> Array('workshopnotes' => 'workshopnotes_no'),
		'workshopnotes_execdate' => array('workshopnotes' => 'workshopnotes_execdate'),
		'workshopnotes_relsoid' => array('workshopnotes' => 'workshopnotes_relsoid'),
		'Assigned To' => Array('crmentity' => 'smownerid')
	);
	var $list_fields_name = Array(
		/* Format: Field Label => fieldname */
		'workshopnotes_no'=> 'workshopnotes_no',
		'workshopnotes_execdate'=> 'workshopnotes_execdate',
		'workshopnotes_relsoid'=> 'workshopnotes_relsoid',
		'Assigned To' => 'assigned_user_id'
	);

	// Make the field link to detail view from list view (Fieldname)
	var $list_link_field = 'workshopnotes_no';
	...
	var $popup_fields = Array('workshopnotes_no');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	var $sortby_fields = Array();

	// For Alphabetical search
	var $def_basicsearch_col = 'workshopnotes_no';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'workshopnotes_no';

	// Required Information for enabling Import feature
	var $required_fields = Array('workshopnotes_no'=>1);

	// Callback function list during Importing
	var $special_functions = Array('set_import_assigned_user');

	var $default_order_by = 'workshopnotes_no';
	var $default_sort_order='ASC';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'workshopnotes_no');
